...
if __name__ == "__main__":
    ...
    for repo_info in repositories:
        ...
        feature_counter = FeatureCounter(repo_url, [StructuralPatternMatchingVisitor,UnpackVisitor,NonlocalStatementVisitor,FunctionAnnotationsVisitor,KeywordOnlyArgumentsVisitor,TypeParameterVisitor,TypeHintVisitor])
